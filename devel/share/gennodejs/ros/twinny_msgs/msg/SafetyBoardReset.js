...
class SafetyBoardReset {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SafetyBoardReset(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SafetyBoardReset(null);
...
module.exports = SafetyBoardReset;
