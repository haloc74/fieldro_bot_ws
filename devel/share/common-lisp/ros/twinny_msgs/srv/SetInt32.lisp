...
(cl:defmethod cl:initialize-instance :after ((m <SetInt32-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetInt32-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name twinny_msgs-srv:<SetInt32-request> is deprecated: use twinny_msgs-srv:SetInt32-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetInt32-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetInt32-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name twinny_msgs-srv:<SetInt32-response> is deprecated: use twinny_msgs-srv:SetInt32-response instead.")))
