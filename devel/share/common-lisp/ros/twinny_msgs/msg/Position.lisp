...
(cl:defmethod cl:initialize-instance :after ((m <Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name twinny_msgs-msg:<Position> is deprecated: use twinny_msgs-msg:Position instead.")))
