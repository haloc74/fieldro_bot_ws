...
"""autogenerated by genpy from twinny_msgs/LampControl.msg. Do not edit."""
import codecs
import sys
...
class LampControl(genpy.Message):
  _md5sum = "5ecbc415e2e3fe2c315df80bc2d55b1d"
  _type = "twinny_msgs/LampControl"
...
"""
  ...
  __slots__ = ['header','type','lamp_control']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LampControl, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.type is None:
        self.type = ''
      if self.lamp_control is None:
        self.lamp_control = 0
    else:
      self.header = std_msgs.msg.Header()
      self.type = ''
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.lamp_control,) = _get_struct_B().unpack(str[start:end])
      return self
