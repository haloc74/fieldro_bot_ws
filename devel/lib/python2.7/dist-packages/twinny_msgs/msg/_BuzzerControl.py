...
"""autogenerated by genpy from twinny_msgs/BuzzerControl.msg. Do not edit."""
import codecs
import sys
...
class BuzzerControl(genpy.Message):
  _md5sum = "2deb2adab106391fb0b57e805d1b2cd7"
  _type = "twinny_msgs/BuzzerControl"
...
"""
  ...
  __slots__ = ['header','type','buzzer_control']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BuzzerControl, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.type is None:
        self.type = ''
      if self.buzzer_control is None:
        self.buzzer_control = 0
    else:
      self.header = std_msgs.msg.Header()
      self.type = ''
      self.buzzer_control = 0
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.buzzer_control,) = _get_struct_B().unpack(str[start:end])
      return self
